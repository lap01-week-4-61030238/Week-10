...
เปลี่ยนสีพื้นหลงัเป็นสีเขียวอ่อน
```charsp
...
this.Hieght=300;
```
กำหนดขนาดของฟร์อมให้เต็มหน้าจอ
```charsp
...
```charsp
 *เมื่อกดปุ่ม Hello ไม่มีอะไรเกิดขึ้น
```
...
***ก่อนเอาเมาส์คลิกที่ปุ่ม Hello***

![](images/3.PNG)

***หลังจากที่เอาเมาส์คลิกที่ปุ่ม Hello***
...
*****propertyGrid1แสดงวันเวลาที่ถูกสร้างข้ึนและการเปิดใชล้่าสุดของไฟลนั้น*****
 
 ![](images/8.PNG)
 
**ไม่มีอะไรเปลี่ยนแปลงแสดงเหมือนเดิม**
...
![](images/9.PNG)
```charsp
สีของpictureBox1เปลี่ยนสีตามที่เลือก
...
![](images/11.PNG)
```charsp
เลือก font ZoodRangmah เมื่อพิมพ์ใน textbox1 จะยังไม่เกิดการเปลี่ยนแปลง
...
![](images/12.PNG)
```charsp
เมื่อกดปุ่ม Update text ลักษณะ font จะเปลี่ยนเป็นแบบที่เลือกใน font Dialog
